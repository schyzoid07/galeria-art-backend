...
-- 3. USUARIO MIGUEL (ID Usuario: 1)
INSERT INTO users (login, password, nombre, apellido, email, telefono, activo) VALUES ('miguel01', 'password123', 'Miguel', 'Usuario', 'miguel@test.com', '04141234567', TRUE);

-- 4. MIGUEL COMO COMPRADOR (Relacionado al ID 1)
...
-- 5. RESPUESTAS DE SEGURIDAD PARA MIGUEL (Relacionadas al user_id: 1)
